...
class Api extends Base {
	...
	schoolGet(param, callback) {
		var allParams = {
			url: 'Common/School/get',
			type: 'post',
			data: param,
			sCallback: function(data) {
				callback && callback(data);
	...
	schoolRankGet(param, callback) {
		var allParams = {
			url: 'Common/SchoolRank/get',
			type: 'post',
			data: param,
			sCallback: function(data) {
				callback && callback(data);
	...
	schoolSpecialGet(param, callback) {
		var allParams = {
			url: 'Common/SchoolSpecial/get',
			type: 'post',
			data: param,
			sCallback: function(data) {
				callback && callback(data);
	...
	specialGet(param, callback) {
		var allParams = {
			url: 'Common/Special/get',
			type: 'post',
			data: param,
			sCallback: function(data) {
				callback && callback(data);
	...
	scoreGet(param, callback) {
		var allParams = {
			url: 'Common/Score/get',
			type: 'post',
			data: param,
			sCallback: function(data) {
				callback && callback(data);
	...
	schoolProvinceScoreGet(param, callback) {
		var allParams = {
			url: 'Common/SchoolProvinceScore/get',
			type: 'post',
			data: param,
			sCallback: function(data) {
				callback && callback(data);
	...
	provinceGet(param, callback) {
		var allParams = {
			url: 'Common/Province/get',
			type: 'post',
			data: param,
			sCallback: function(data) {
				callback && callback(data);
